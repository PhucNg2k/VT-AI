...
def mirror_norm_vec(norm: list[float]):
    flipped = norm.copy()
    return -flipped
...
if __name__ == "__main__":
    ...
    import time
    fpath = r"../../Public data task 3\Public data\Public data test\ply\0050.ply"
    ...
    o3d.geometry.PointCloud.orient_normals_consistent_tangent_plane(pcd, 100)
    ...
    voxel_grid = o3d.geometry.VoxelGrid.create_from_point_cloud(pcd, voxel_size=voxelsize)
